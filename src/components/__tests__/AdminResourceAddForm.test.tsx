...
import { fireEvent, getByTestId, prettyDOM, render, screen, waitFor, waitForElementToBeRemoved } from "@testing-library/react";
...
const buildMocks = (): {
    ...
    _mocks.push({
        request: {
            ...
            variables: {
                disorderId: "disorder_id_1", modelId: "model_id_1"
            },
        },
        result: {
            data: {
...
describe('Admin Resource Add Form', () => {
    ...
    it('should render resource-type options by default', async () => {
        ...
        expect(screen.queryByTestId("resource_type").getAttribute('value')).toBe("2");
    });
