...
import TherapistPatientEditTemplatePage from "../pages/therapist/patient/view/[id]/formulation/edit/[ptShareId]";
  ...
  render(
    <MockedProvider mocks={mocksData} addTypename={false}>
      <ThemeProvider theme={theme()}>
        <SnackbarProvider>
          <TherapistPatientEditTemplatePage />
        </SnackbarProvider>
      </ThemeProvider>
    </MockedProvider>
  );
...
describe("Formulation detail page", () => {
  ...
  it("formulation doc", async () => {
    useRouter.mockImplementation(() => ({
      query: {
        ptShareId: "46cb932a4c6346268ec4c13009cdd1b6",
      },
    }));
    await sut();
    await waitFor(() => {
  ...
  it(" submit template formulation", async () => {
    useRouter.mockImplementation(() => ({
      query: {
        ptShareId: "46cb932a4c6346268ec4c13009cdd1b5",
      },
    }));
    await sut();
    await waitFor(async () => {
  ...
  it(" cancel template formulation", async () => {
    ...
    await (async () => {
      expect(pushMock).toHaveBeenCalledWith(
        "therapist/patient/view/27f49dbe245843eda77fe5170ee074a8/?mainTab=therapy&tab=formulation"
      );
    });
  });
});
