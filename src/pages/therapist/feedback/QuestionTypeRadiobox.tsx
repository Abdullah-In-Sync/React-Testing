...
export default function QuestionTypeRadiobox({ fv, fk, disable }): JSX.Element {
    return (
        <Typography gutterBottom component="div">
            <Typography sx={{
                backgroundColor: "#dadada52 !important", border: "1px solid #dadada52 !important",
            ...
            <FormControl>
                <RadioGroup
                    ...
                    defaultValue={fv.feedback_ans && fv.feedback_ans.answer ? fv.feedback_ans.answer : ''}
                >
                    {
                        fv.answer_options && fv.answer_options.map((av, ak) => {
