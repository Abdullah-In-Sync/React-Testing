...
const PatientEditTemplatePage: NextPage = () => {
  ...
  const [getFormulation, { data:  getFormulationByShareId }] = useLazyQuery(GET_FORMULATION_BY_SHARE_ID, {
    ...
    onCompleted: (data) => {
      ...
      if (data?.getFormulationByShareId) {
        const Obj = {
          ...
          component_name: data?.getFormulationByShareId[0]?.template_detail?.component_name,
